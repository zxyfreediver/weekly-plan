# 周记清单 | 周报月报年报 AI 智能总结 · 个人任务管理

> 周记清单：个人周度任务管理工具，支持**周报**、**月报**、**年报** AI 智能总结。按周组织待办清单，一键生成周报月报，职场人必备的效率工具。

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

**关键词**：周记 · 清单 · 周报 · 月报 · 年报 · 智能总结 · AI 总结 · 任务管理 · 待办清单 · 周度规划
...
- **AI 智能总结**：支持周报、半月报、月报、年报，可自定义模板，一键生成总结
...
支持**周报**、**半月报**、**月报**、**年报**，选择时间范围或具体周，一键生成已完成任务的 AI 总结，可自定义模板让 AI 按格式输出。
...
| **AI 智能总结** | 周报、半月报、月报、年报，支持自定义模板，DeepSeek 驱动 |
...
# 编辑 .env.local 填入 AUTH_USERNAME（默认 admin）、AUTH_PASSWORD、Supabase 凭证、DEEPSEEK_API_KEY（AI 总结）
